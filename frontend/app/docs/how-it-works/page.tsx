...
const Step = ({ n, title, children }: { n: number; title: string; children: React.ReactNode }) => (
  <div className="flex gap-4 mb-8">
    <div className="shrink-0 w-8 h-8 rounded-full bg-cyan-500/10 border border-cyan-500/20 flex items-center justify-center text-cyan-400 text-sm font-semibold">
      {n}
    </div>
    <div>
  ...
  return (
    <article className="prose-docs">
      ...
      <div className="not-prose mt-6">
        <Step n={1} title="You compose your order in the app">
          <p>
        ...
        <Step n={2} title="Your browser encrypts the order">
          <p>
            Before anything leaves your device, the SDK encrypts the order payload using
            AES-GCM with a one-time session key. That session key itself is encrypted with the
        ...
        <Step n={3} title="Your wallet signs a commitment on Starknet">
          <p>
        ...
        <Step n={4} title="Orders collect in a 30-second batch window">
          <p>
        ...
        <Step n={5} title="Solvers compete to fill the batch">
          <p>
        ...
        <Step n={6} title="The winning solution settles on-chain">
          <p>
        ...
        <Step n={7} title="Your app shows the result">
          <p>
      ...
      <p>
        Solvers who submit consistently bad solutions — or who win auctions and then fail to
        settle — are slashed from their bond and can be blacklisted after repeated failures.
      </p>
